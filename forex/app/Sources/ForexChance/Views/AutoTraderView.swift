...
struct AutoTraderView: View {
    ...
    private var configCard: some View {
        VStack(alignment: .leading, spacing: 14) {
            ...
            configSlider(label: "Reward/Risk ratio", value: $vm.rrRatio, range: 1.5...4, step: 0.5, format: "%.1fx")
            configSlider(label: "Daily loss limit", value: $vm.dailyLossLimitPct, range: 1...6, step: 0.5, format: "%.1f%%")
            configSlider(label: "Min confidence", value: $vm.minConfidence, range: 50...80, step: 5, format: "%.0f%%")
            ...
            configStepper(label: "Max trades/day", value: $vm.maxTradesPerDay, range: 1...15)
